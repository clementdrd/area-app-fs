...
public class OfficeFragment extends Fragment implements MyRecyclerViewAdapterService.ItemClickListener {
    ...
    public static OfficeFragment createInstance(String userName) {
